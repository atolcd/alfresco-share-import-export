...
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/components/console/export.css" />
...
<@script type="text/javascript" src="${page.url.context}/res/components/console/export.js"></@script>
